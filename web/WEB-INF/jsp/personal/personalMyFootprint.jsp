                ...
                <div class="col-md-2">
                    <div>
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            ...
                            <li class="active"><a href="/personal/${account.accountId}/myFootprint?page=1">${who}的足迹</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="nav-page" id="selectContainer"><%--这里插入页面--%>
                            ...
                            <div class="border-20 displayContainer">
                                <c:if test="${!empty pageInfo.pageDatas}">
                                    ...
                                    <c:forEach items="${pageInfo.pageDatas}" var="footprint" varStatus="idx">

                                        <c:choose>
                                            <c:when test="${footprint.operationCode==1}">
                                                <div class="selectItem">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="/img/coin/coin.png" width="20px" height="20px"
                                                                 class="img-rounded">${footprint.experience}
                                                            <img src="/img/coin/coin.png" width="20px" height="20px"
                                                                 class="img-rounded">${footprint.coin}
                                                        </div>
                                                        <div class="col-md-10">
                                                            发布问题
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <a target="_blank" href="/question/detail/${footprint.questionId}">${footprint.title}</a>
                                                        </div>
                                                        <div class="col-md-2">
                                            ...
                                            <c:when test="${footprint.operationCode==2}">
                                                <div class="selectItem">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="/img/coin/coin.png" width="20px" height="20px"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <a target="_blank" href="/question/detail/${footprint.questionId}"></a>
                                                        </div>
                                                        <div class="col-md-2">
                                                                ${footprint.createTime}
                                                        </div>
                                            ...
                                            <c:when test="${footprint.operationCode==3}">
                                                <div class="selectItem">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="/img/coin/coin.png" width="20px" height="20px"
                                                        ...
                                                        <div class="col-md-10">
                                                            点赞(我赞了<a target="_blank" href="/personal/${footprint.accountBId}">${footprint.name}</a>)
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-10">
                                            ...
                                            <c:when test="${footprint.operationCode==4}">
                                                <div class="selectItem">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="/img/coin/coin.png" width="20px" height="20px"
                                                        ...
                                                        <div class="col-md-10">
                                                            被赞(<a target="_blank" href="/personal/${footprint.accountBId}">${footprint.name}</a>赞了我)
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-10">
