                ...
                <div class="col-md-2">
                    <div>
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            ...
                            <li class="active"><a href="/personal/${account.accountId}/myGift?page=1">${who}的礼物</a></li>
                    ...
                    <div class="nav-content">
                        ...
                        <div class="nav-page" id="selectContainer"><%--这里插入页面--%>
                            ...
                            <div class="border-20 displayContainer">
                                ...
                                <c:forEach items="${pageInfo.pageDatas}" var="gift" varStatus="idx">
                        ...
                        <ul class="pagination">
                            <c:if test="${pageInfo.hasPrevious}">
                                <li><a href="/personal/${account.accountId}/myGift?page=${pageInfo.previousPage}">&laquo;上一页</a></li>
                            </c:if>
                            ...
                            <c:if test="${pageInfo.hasNext}">
                                <li><a href="/personal/${account.accountId}/myGift?page=${pageInfo.nextPage}">下一页&raquo;</a></li>
                            </c:if>
                        </ul>
                    </div><%--pagination 分页结束--%>
