                ...
                <div class="col-md-2">
                    <div class="personal-nav">
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            ...
                            <li class="active"><a href="/personal/${account.accountId}/myAnswer?page=1">${who}的回答</a></li>
                    ...
                    <div class="personal-content">
                        ...
                        <div class="border-20 displayContainer">
                            ...
                            <c:if test="${!empty pageInfo.pageDatas}">
                                ...
                                <c:forEach items="${pageInfo.pageDatas}" var="answer" varStatus="idx">
                                    <div class="selectItem "> 
                                        <div class="row"> 
                                            <div class="col-md-1">问题</div> 
                                            <div class="col-md-11"><a target="_blank" class="singleText" href="/question/detail/${answer.questionId}">${answer.title}</a></div>
                                            </div> 
                                        <div class="row"> 
                                            <div class="col-md-1">回答</div> 
                                            <div class="col-md-8"><a target="_blank" class="singleText" href="/question/detail/${answer.questionId}">${answer.content}</a></div>
                                            <div class="col-md-1"> <a  class="btn btn-success btn-xs"><span class="glyphicon glyphicon-thumbs-up"></span> 5</a></div> 
                                            <div class="col-md-2"><span class="">${answer.createYearDay}</span></div> 
                                            </div> 
                                        </div>
                        ...
                        <div class="page">
                            <ul class="pagination">
                                <c:if test="${pageInfo.hasPrevious}">
                                    <li>
                                        <a href="/personal/${account.accountId}/myAnswer?page=${pageInfo.previousPage}">&laquo;上一页</a>
                                    </li>
                                </c:if>
                                ...
                                <c:forEach var="x" begin="${pageInfo.pageStart}"
                                    ...
                                    <c:if test="${pageInfo.currentPage!=x}">
                                        <li><a href="/personal/${account.accountId}/myAnswer?page=${x}">${x}</a></li>
                                    </c:if>
                                </c:forEach>


                                <c:if test="${pageInfo.hasNext}">
                                    <li><a href="/personal/${account.accountId}/myAnswer?page=${pageInfo.nextPage}">下一页&raquo;</a>
                                    </li>
                                </c:if>
                            </ul>
