                ...
                <div class="col-md-2">
                    <div class="personal-nav">
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            ...
                            <li class="active"><a href="/personal/${account.accountId}/myCollect?page=1">${who}的收藏</a></li>
                    ...
                    <div class="personal-content">
                        ...
                        <div class="border-20 displayContainer">
                            ...
                            <c:if test="${!empty pageInfo.pageDatas}">
                                ...
                                <c:forEach items="${pageInfo.pageDatas}" var="collect" varStatus="idx">
                                    <div class="selectItem row"> 
                                        ...
                                        <div class="col-md-9"><a target="_blank" class="singleText" href="/question/detail/${collect.questionId}">${collect.title}</a></div>
                                        <div class="col-md-2"><span class=>${collect.createYearDay}</span></div> 
                                        </div>
                        ...
                        <div class="page">
                            <ul class="pagination">
                                <c:if test="${pageInfo.hasPrevious}">
                                    <li>
                                        <a href="/personal/${account.accountId}/myCollect?page=${pageInfo.previousPage}">&laquo;上一页</a>
                                    </li>
                                </c:if>
                                ...
                                <c:forEach var="x" begin="${pageInfo.pageStart}"
                                    ...
                                    <c:if test="${pageInfo.currentPage!=x}">
                                        <li><a href="/personal/${account.accountId}/myCollect?page=${x}">${x}</a></li>
                                    </c:if>
                                </c:forEach>


                                <c:if test="${pageInfo.hasNext}">
                                    <li><a href="/personal/${account.accountId}/myCollect?page=${pageInfo.nextPage}">下一页&raquo;</a>
                                    </li>
                                </c:if>
                            </ul>
