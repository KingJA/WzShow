        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 ">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn mr10 btn-success text-center">加关注 </a>
                        </div>
                        <div class="col-md-6">
                            <a class="btn btn-default text-center" href="javascript:void(0);">发私信</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                ...
                <div class="col-md-2">
                    ...
                    <div>
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            <li><a href="javascript:void(0);" onclick="myAsk(1)">TA的提问</a></li>
                            <li><a href="javascript:void(0);" onclick="myAnswer(1)">TA的回答</a></li>
                            <li><a href="javascript:void(0);" onclick="myAttention(this)">TA的关注</a></li>
                            <li><a href="javascript:void(0);" onclick="myCollect(this)">TA的收藏</a></li>
                        </ul>
