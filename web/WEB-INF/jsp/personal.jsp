...
<body style="padding-top: 50px ;background: #eeeeee;">
<%--==================================导航============================================--%>
                ...
                <div class="col-md-2 ">
                    <div >
                        <ul class="nav nav-pills nav-stacked profile__nav">
                            ...
                            <li><a href="/u/kingjavip/">我的回答</a></li>
                            <li><a href="/u/kingjavip/answers">我的提问</a></li>
                            <li><a href="/u/kingjavip/questions">我的关注</a></li>
                            <li><a href="/u/kingjavip/articles">我的收藏</a></li>
                        </ul>
